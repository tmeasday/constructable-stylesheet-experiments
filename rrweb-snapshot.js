var rrwebSnapshot = (function (exports) {
  ...
  function isNodeMetaEqual(a, b) {
    ...
    if (a.type === exports.NodeType.Document)
      ...
      a.type === exports.NodeType.Comment ||
  ...
  function serializeElementNode(n, options) {
    ...
    if (tagName === "img" && inlineImages) {
      ...
      if (image_1.complete && image_1.naturalWidth !== 0) recordInlineImage_1();
      else image_1.addEventListener("load", recordInlineImage_1);
    }
  ...
  function serializeNodeWithId(n, options) {
    ...
    if (
      (serializedNode.type === exports.NodeType.Document ||
  ...
  function visitSnapshot(node, onVisit) {
    function walk(current) {
      onVisit(current);
      if (
        current.type === exports.NodeType.Document ||
  ...
  function buildNodeWithSN(n, options) {
    ...
    mirror.add(node, n);
    if (
      (n.type === exports.NodeType.Document ||
        n.type === exports.NodeType.Element) &&
      !skipChild
    ) {
      var _loop_2 = function (childN) {
        ...
        if (childN.isShadow && isElement(node) && node.shadowRoot) {
          ...
          htmlElement.childNodes.forEach(function (child) {
            if (child.nodeName === "BODY") body_1 = child;
          });
          if (body_1) {
  ...
  function handleScroll(node, mirror) {
    ...
    if (
      (n === null || n === void 0 ? void 0 : n.type) !==
      exports.NodeType.Element
    ) {
      return;
    }
    var el = node;
